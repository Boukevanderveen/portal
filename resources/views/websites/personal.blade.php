            ...
            < Terug</button>
                <nav class="hidden lg:block flex px-5 py-2 text-gray-700 " aria-label="Breadcrumb">
                    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                        ...
                        <li class="inline-flex items-center">
                            <a href="{{ route('websites.personal') }}"
                                class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600 dark:text-gray-400 dark:hover:text-white">
                ...
                <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow = col-span-3 lg:col-span-1">
                    ...
                    <div class="p-5">
                        ...
                        <p class="mb-1 text-gray-500"><i class="fa fa-envelope" aria-hidden="true"></i>
                            ...
                            <a href="mailto:?&subject={{ $website->name }}&body={{ $website->link }}">Stuur email</a>
                        </p>
                        ...
                        <a
                            href="{{ route('websites.edit', $website) }}"class="bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow">
                            Bewerk
                        </a>
                    </div>
                </div>
