...
@section('content')
    <div class="grid grid-cols-5 ">
        ...
        <div class="col-start-1 col-span-5 w-full bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 ">
            <form method="post" onsubmit="doSubmit()" action="{{ route('websites.update', $website) }}"
                        ...
                        <div class="mb-3">
                            ...
                            <select class="text-sm w-full p-2.5 rounded" id="isPublic" name="isPublic">
                                <option value="0"
                                    ...
                                    @endif>Privé</option>
                                <option value="1"
                                    @if (old('isPublic') !== null && old('isPublic') == 1) selected @else @if (null == old('isPublic') && $website->isPublic) selected @endif
