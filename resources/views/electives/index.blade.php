...
@section('content')
    ...
    <div class="text-3xl col-start-1 col-span-1">
        <span class="bg-gray-400 text-3xl">Keuzedelen</span>
    </div>
    <div class="grid gap-4 lg:grid-cols-3 md:grid-cols-2 sm: alg-cols-1">
        @foreach ($electives as $elective)
            <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow =">
                ...
                <div role="button" class="p-5"
                    onclick="location.href='{{ URL::route('electives.show', $elective) }}';">
