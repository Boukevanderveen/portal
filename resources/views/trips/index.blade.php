...
<nav class="hidden lg:block flex px-5 py-2 text-gray-700 " aria-label="Breadcrumb">
  <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
    ...
    <li class="inline-flex items-center">
      <a href="{{ route('trips.index') }}" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600 dark:text-gray-400 dark:hover:text-white">
        ...
        <div class="grid gap-4 lg:grid-cols-3 md:grid-cols-2 sm: alg-cols-1">
            ...
            <img style="width: 400px; height: 300px" src="{{ asset('/images/trips/'. $trip->id .'/'. $trip->picture.'') }}">
