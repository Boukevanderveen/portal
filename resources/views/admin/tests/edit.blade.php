                ...
                <div class="grid grid-cols-5 gap-4">
                    <div class="text-3xl col-start-1 col-span-5 lg:col-start-2 lg:col-span-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input value="{{ old('name', $test->name) }}"
                        ...
                        <div class="mb-3">
                            ...
                            <input value="{{ old('school_year', $test->school_year) }}"
                                class="shadow appearance-none border @error('school_year') border-red-500 @enderror  rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline"
                        ...
                        <div class="mb-3">
                            ...
                            <input value="{{ old('period', $test->period) }}"
                        ...
                        <div class="mb-3">
                            ...
                            <input value="{{ old('date', $test->date) }}"
                                class="shadow appearance-none border @error('date') border-red-500 @enderror  rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline"
                        ...
                        <div class="mb-3">
                            ...
                            <input value="{{ old('time', $test->time) }}"
                                class="shadow appearance-none border @error('time') border-red-500 @enderror  rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline"
                        ...
                        <div class="mb-3">
                            ...
                            <input value="{{ old('resit_date', $test->resit_date) }}"
                                class="shadow appearance-none border @error('resit_date') border-red-500 @enderror  rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline"
                        ...
                        <div>
                            ...
                            <input value="{{ old('resit_time', $test->resit_time) }}"
                                class="shadow appearance-none border @error('resit_time') border-red-500 @enderror  rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline"
                        ...
                        <div class="mb-3">
                            ...
                            <select class="text-sm w-full p-2.5 rounded" id="registerable" name="registerable">
                                <option value="0"
                                    @if (old('registerable') !== null && old('registerable') == 0) selected @else @if (!$test->registerable) selected @endif
                                    @endif>Niet inschrijfbaar</option>
                                <option value="1"
                                    @if (old('registerable') !== null && old('registerable') == 1) selected @else @if (null == old('registerable') && $test->registerable) selected @endif
