                    ...
                    <div class="text-3xl col-start-1 col-span-5 lg:col-start-2 lg:col-span-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="text-sm w-full p-2.5 rounded" id="registerable" name="registerable">
                                <option selected value="0" @if (old('registerable') !== null && old('registerable') == 0) selected @endif>Niet
                                    inschrijfbaar</option>
                                <option value="1" @if (old('registerable') !== null && old('registerable') == 1) selected @endif>Inschrijfbaar
                                </option>
                            </select>
                        </div>
