                ...
                < Terug</button>
                    <nav class="hidden lg:block flex px-5 py-2 text-gray-700 " aria-label="Breadcrumb">
                        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                            ...
                            <li class="inline-flex items-center">
                                <a href="{{ route('admin.projectweeks.registrations.index', $projectweek) }}"
                                    class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600 dark:text-gray-400 dark:hover:text-white">
                    ...
                    <tbody>
                        @foreach ($registrations as $registration)
                            <tr class="bg-white border-b ">
                                ...
                                <td>
                                    <form method="post"
                                        action="{{ route('admin.projectweeks.registrations.destroy', [$projectweek, $registration]) }}">
                                        @csrf
                                        @method('delete')
                                        <button type="submit"
                ...
                <div class="relative bg-white rounded-lg shadow ">
                    ...
                    <div class="px-6 py-6 lg:px-8">
                        ...
                        <form class="space-y-6" method="POST"
                            action="{{ route('admin.projectweeks.registrations.store', $projectweek) }}">
                            @csrf
