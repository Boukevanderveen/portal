                ...
                <div class="grid grid-cols-5 gap-4">
                    <div class="text-3xl col-start-1 col-span-5 lg:col-start-2 lg:col-span-3">
                        <div class="mb-3">
                            ...
                            <input value="{{ old('name', $subject->name) }}"
                        ...
                        <div class="mb-3">
                            ...
                            <textarea rows="4" id="editor" class="prose" name="description" id="description">{{ old('description', $subject->description) }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <input value="{{ old('practical_hours', $subject->practical_hours) }}"
                                class="shadow appearance-none border @error('practical_hours') border-red-500 @enderror  rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline"
                        ...
                        <div class="mb-3">
                            ...
                            <input value="{{ old('theory_hours', $subject->theory_hours) }}"
                                class="shadow appearance-none border @error('theory_hours') border-red-500 @enderror  rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline"
                        ...
                        <div class="mb-3">
                            ...
                            <input value="{{ old('selfstudy_hours', $subject->selfstudy_hours) }}"
                                class="shadow appearance-none border @error('selfstudy_hours') border-red-500 @enderror  rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline"
                        ...
                        <div class="mb-3">
                            ...
                            <input value="{{ old('teacher', $subject->teacher) }}"
                                class="shadow appearance-none border @error('teacher') border-red-500 @enderror  rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline"
                        ...
                        <div class="mb-3">
                            ...
                            <input value="{{ old('period', $subject->period) }}"
