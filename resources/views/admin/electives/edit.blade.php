...
@section('content')
    <div class="grid grid-cols-5 gap-4">
                        ...
                        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                            ...
                            <li class="inline-flex items-center">
                                <a href="{{ route('admin.electives.edit', $elective) }}"
                                    class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600 dark:text-gray-400 dark:hover:text-white">
                                    <p class="ml-1"> > Bewerk keuzedeel </p>
                                </a>
                            </li>
                        </ol>
                    </nav>
        ...
        <div class="text-3xl col-start-1 col-span-5">
            <span class="bg-black">Bewerk keuzedeel</span>
        </div>
                ...
                <div class="grid grid-cols-5 gap-4">
                    <div class="text-3xl col-start-1 col-span-5 lg:col-start-2 lg:col-span-3">
                        <div class="mb-3">
                            ...
                            <input value="{{ old('name', $elective->name) }}"
                        ...
                        <div class="mb-3">
                            ...
                            <input value="{{ old('hours', round($elective->hours, 0)) }}"
                                class="shadow appearance-none border @error('hours') border-red-500 @enderror  rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline"
                        ...
                        <div class="mb-3">
                            ...
                            <input value="{{ old('teacher', $elective->teacher) }}"
                        ...
                        <div class="mb-3">
                            ...
                            <input value="{{ old('period', $elective->period) }}"
                        ...
                        <div class="mb-3">
                            ...
                            <input value="{{ old('code', $elective->code) }}"
                                class="shadow appearance-none border @error('code') border-red-500 @enderror  rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline"
