...
<div class="grid grid-cols-5 grid-rows-1 gap-0">
                ...
                <div class="col-span-2">
                    <button onclick="window.location='{{ route('admin.electives.create') }}'" type="button"
                        class="float-right focus:outline-none font-bold text-950 bg-[#ffcd00] hover:bg-yellow-400 focus:ring-4 focus:ring-yellow-300 rounded-sm text-sm px-3 lg:px-5 py-2.5 me-2 mb-2 dark:focus:ring-yellow-900">Nieuw
                        keuzedeel</button>
                </div>
                <div class="col-start-1 col-span-3">
                    <form id="searchForm" action="{{ route('admin.electives.search') }}">
                        @csrf
                        <div class="flex">
