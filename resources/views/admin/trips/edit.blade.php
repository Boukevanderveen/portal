                ...
                <div class="grid grid-cols-5 gap-4">
                    <div class="text-3xl col-start-1 col-span-5 lg:col-start-2 lg:col-span-3">
                        <div class="mb-3">
                            ...
                            <input value="{{ old('name', $trip->name) }}"
                        ...
                        <div class="mb-3">
                            ...
                            <input value="{{ old('school_year', $trip->school_year) }}"
                                class="shadow appearance-none border @error('name') border-red-500 @enderror  rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline"
                        ...
                        <div class="mb-3">
                            ...
                            <input value="{{ old('date', $trip->date) }}"
                        ...
                        <div class="mb-3">
                            ...
                            <input value="{{ old('time', $trip->time) }}"
                        ...
                        <div class="mb-3">
                            ...
                            <input value="{{ old('location', $trip->location) }}"
                                class="shadow appearance-none border @error('location') border-red-500 @enderror  rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline"
                        ...
                        <div class="mb-3">
                            ...
                            <input value="{{ old('link', $trip->link) }}"
