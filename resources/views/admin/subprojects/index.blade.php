            ...
            <table class="w-full text-sm text-left bg-[#3a5757]">
                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b ">
                        ...
                        <td class="min-w-28">
                            <form method="post" action="{{ route('admin.subprojects.destroy', $subproject) }}"> @csrf
                                @method('delete')
                            <button type="submit"
                            onclick="return confirm('Weet je zeker dat je {{ $subproject->name }} wilt verwijderen?')" role="button" class="fa fa-trash float-right mr-5" aria-hidden="true">
