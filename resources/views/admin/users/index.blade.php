...
<div class="grid grid-cols-1 gap-4">
        ...
        <div class="text-3xl col-start-1 col-span-1">
            Gebruikers
            <button onclick="window.location='{{ route('admin.users.create') }}'" type="button"  class="float-right text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Nieuwe gebruiker</button>
        </div>
