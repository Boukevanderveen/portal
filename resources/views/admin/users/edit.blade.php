                    ...
                    <div class="text-3xl col-start-2 col-span-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="appearance-none rounded w-full" id="is_admin" name="is_admin">
                                <option value="0" @if(old('is_admin') !== null && old('is_admin') == 0) selected @elseif($user->isAdmin == 0) selected @endif>Gebruiker</option>
                                <option value="1" @if(old('is_admin') !== null && old('is_admin') == 1) selected @elseif($user->isAdmin == 1) selected @endif >Admin</option>
                            </select>
