                ...
                <div class="grid grid-cols-5 gap-4">
                    <div class="text-3xl col-start-2 col-span-3">
                        <div class="mb-3">
                            ...
                            <input value="{{ old('name', $project->name) }}"
                        ...
                        <div class="mb-3">
                            ...
                            <select class="text-sm w-full p-2.5 rounded" id="highlighted" name="highlighted">
                                <option value="0"
                                    @if (old('highlighted') !== null && old('highlighted') == 0) selected @else @if (!$project->highlighted && !$project->highlighted) selected @endif
                                    @endif>Nee</option>
                                <option value="1"
                                    @if (old('highlighted') !== null && old('highlighted') == 1) selected @else @if (null == old('highlighted') && $project->highlighted) selected @endif
                                    @endif >Ja</option>
                            </select>
