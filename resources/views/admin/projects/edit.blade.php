...
@section('content')
    ...
    <nav class="hidden lg:block flex px-5 py-2 text-gray-700 " aria-label="Breadcrumb">
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            ...
            <li class="inline-flex items-center">
            <a href="{{ route('admin.projects.edit', $project) }}" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600 dark:text-gray-400 dark:hover:text-white">
                <p class="ml-1"> > Bewerk project </p>
            </a>
            </li>
        </ol>
    </nav>
                    ...
                    <div class="text-3xl col-start-2 col-span-3">
                        ...
                        <div class="mb-3">
                            ...
                            class="shadow appearance-none border @error('intro') border-red-500 @enderror  rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline"
                                name="intro" id="intro" type="text">{{old('intro', $project->intro)}}</textarea>
                            @if ($errors->has('intro'))
                        ...
                        <div class="mb-3">
                            ...
                            <select class="text-sm w-full p-2.5 rounded" id="highlighted" name="highlighted">
                                <option value="0" @if(old('highlighted') !== null && old('highlighted') == 0) selected @else @if(!$project->highlighted && !$project->highlighted) selected @endif @endif>Nee</option>
                                <option value="1" @if(old('highlighted') !== null && old('highlighted') == 1) selected @else @if(null == old('highlighted') && $project->highlighted) selected @endif @endif >Ja</option>
                            </select>
