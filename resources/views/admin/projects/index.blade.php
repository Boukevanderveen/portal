        ...
        <div class="grid grid-cols-5 grid-rows-1 gap-0">
            ...
            <div class="col-span-2">
                <button onclick="window.location='{{ route('admin.projects.create') }}'" type="button"
                    class="float-right focus:outline-none font-bold text-950 bg-[#ffcd00] hover:bg-yellow-400 focus:ring-4 focus:ring-yellow-300 rounded-sm text-sm px-5 py-2.5 me-2 mb-2 dark:focus:ring-yellow-900">Nieuw project
                </button>
            </div>
