                ...
                <div class="grid grid-cols-5 gap-4">
                    <div class="text-3xl col-start-1 col-span-5 lg:col-start-2 lg:col-span-3">
                        <div class="mb-3">
                            ...
                            <input value="{{ old('name', $book->name) }}"
                        ...
                        <div class="mb-3">
                            ...
                            <input value="{{ old('ISBN', $book->ISBN) }}"
                                class="shadow appearance-none border @error('ISBN') border-red-500 @enderror  rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline"
                        ...
                        <div class="mb-3">
                            ...
                            <input value="{{ str_replace('.', ',', old('price', $book->price)) }}"
                                class="shadow appearance-none border @error('price') border-red-500 @enderror  rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline"
                        ...
                        <div class="mb-3">
                            ...
                            <input value="{{ old('school_year', $book->school_year) }}"
                                class="shadow appearance-none border @error('name') border-red-500 @enderror  rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline"
                        ...
                        <div class="mb-3">
                            ...
                            <input value="{{ old('link', $book->link) }}"
